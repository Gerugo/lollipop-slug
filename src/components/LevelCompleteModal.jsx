    ...
    <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-lg flex items-center justify-center p-2 sm:p-4 select-none overflow-y-auto">
      <div className="candy-card rounded-2xl sm:rounded-3xl p-3 sm:p-5 max-w-md w-full flex flex-col items-center text-center shadow-2xl border-2 border-candy-yellow/60 m-auto max-h-[96dvh] overflow-y-auto">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
          <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-full bg-gradient-to-tr from-candy-blue via-cyan-400 to-candy-mint p-0.5 flex items-center justify-center shadow-lg shadow-candy-blue/40 animate-bounce-soft shrink-0">
            <Trophy size={18} className="text-slate-950 sm:w-6 sm:h-6" />
          </div>
          <div className="text-left">
            <h2 className="text-lg sm:text-2xl font-bungee text-candy-blue tracking-wide leading-tight text-stroke-thin">
              ¡NIVEL COMPLETADO!
            </h2>
        ...
        {/* Action Button - Always visible and tactile */}
        <div className="w-full">
          <button
            onClick={onNextLevel}
            className="w-full py-2.5 sm:py-3.5 px-4 candy-button-blue rounded-xl sm:rounded-2xl font-bungee text-white text-xs sm:text-sm tracking-wider flex items-center justify-center gap-2 active:scale-95 transition-transform shadow-lg"
          >
            <FastForward size={16} className="fill-white stroke-none sm:w-5 sm:h-5" />
