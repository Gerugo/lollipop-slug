    ...
    <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-lg flex items-center justify-center p-2 sm:p-4 select-none overflow-y-auto">
      <div className="candy-card rounded-3xl p-4 sm:p-6 max-w-lg w-full flex flex-col items-center text-center shadow-2xl border-2 border-candy-yellow/60 m-auto max-h-[94vh] overflow-y-auto">
        ...
        <div className="relative mb-1 sm:mb-2">
          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-tr from-candy-blue via-cyan-400 to-candy-mint p-1 flex items-center justify-center shadow-xl shadow-candy-blue/40 animate-bounce-soft">
        ...
        <h2 className="text-2xl sm:text-3xl font-bungee text-candy-blue tracking-wide mb-0.5 text-stroke-thin">
          ¡NIVEL COMPLETADO!
        </h2>
        ...
        <div className="w-full bg-slate-900/85 rounded-2xl p-3 sm:p-4 border border-white/20 mb-4 flex flex-col gap-1.5 sm:gap-2.5 font-arcade text-xs text-slate-200">
          <div className="flex justify-between items-center pb-1.5 border-b border-white/10">
            <span className="text-slate-400 text-[11px] sm:text-xs">TIEMPO DE SECTOR:</span>
        ...
        <div className="flex flex-col w-full">
          <button
            onClick={onNextLevel}
            className="w-full py-3 sm:py-4 px-4 sm:px-6 candy-button-blue rounded-xl sm:rounded-2xl font-bungee text-white text-sm sm:text-base tracking-wider flex items-center justify-center gap-2 active:scale-95 transition-transform shadow-lg"
          >
            <FastForward size={18} className="fill-white stroke-none sm:w-5 sm:h-5" />
