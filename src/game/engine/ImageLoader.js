...
class ImageLoader {
  constructor() {
    ...
    this.sources = {
      ...
      fondo_bosque_l1: new URL('../../assets/fondo-bosque-l1.jpg', import.meta.url).href,
      fondo_sirope_l1: new URL('../../assets/fondo-sirope-l1.jpg', import.meta.url).href,
      fondo_fabrica_l1: new URL('../../assets/fondo-fabrica-l1.jpg', import.meta.url).href,
      fondo_arena_l1: new URL('../../assets/fondo-arena-l1.jpg', import.meta.url).href,
